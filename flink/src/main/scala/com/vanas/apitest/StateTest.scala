...
object StateTest {
    def main(args: Array[String]): Unit = {
        ...
        chkpConfig.setMinPauseBetweenCheckpoints(500L) //这个配置后 上面那个配置相当于1
        chkpConfig.setPreferCheckpointForRecovery(true) //默认是savepoint
        chkpConfig.setTolerableCheckpointFailureNumber(0) //故障恢复 checkpoint时候挂了的时候 0是不允许任何操作失败
        ...
        val dataStream = inputStream
                ...
                .uid("1")  //如果用savepoint做系统更新或恢复 最好把uid指定出来
